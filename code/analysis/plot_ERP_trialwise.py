...
# DATA
parser.add_argument('--patient', default='545', help='Patient string')
...
# QUERY (SELECT TRIALS)
parser.add_argument('--comparison-name', default='all_pseudowords', help='int. Comparison name from Code/Main/functions/comparisons_level.py. see print_comparisons.py')
