...
# ALL WORDS
    ...
    comparisons['all_unigrams']['fixed_constraint'] = 'Event=="StimOn" and Block==1'
    ...
    comparisons['all_ngrams']['fixed_constraint'] = 'Event=="StimOn" and Block==2'
    ...
    comparisons['all_pseudowords_visual']['fixed_constraint'] = 'Event=="StimOn" and Block==3'
